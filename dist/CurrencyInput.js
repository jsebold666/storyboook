...
import CI from 'react-currency-input';
...
var InputSection = styled.section.withConfig({
  displayName: 'InputWrapper__InputSection',
  componentId: 'sc-1p7hco6-0'
})(['width:100%;min-height:88px;box-sizing:border-box;background-color:', ';position:relative;border-left:4px solid ', ';transition:all 300ms cubic-bezier(0.4,0,0.2,1);&.box-edit__wrapper{background-color:', ';border:solid 1px ', ';}&:focus-within{border-left:4px solid ', ';box-shadow:0 0 15px 0 rgba(0,0,0,0.2);z-index:100;}& .box__wrapper{min-height:inherit;display:flex;flex-direction:column;& .label__container{display:flex;flex-direction:row;justify-content:space-between;align-items:center;padding:16px 24px 0px 24px;& label:first-child{font-size:14px;font-weight:normal;font-style:normal;font-stretch:normal;letter-spacing:normal;color:', ';z-index:1;}& label:last-child:not(:first-child){font-size:10px;font-weight:500;font-style:normal;font-stretch:normal;letter-spacing:normal;text-align:right;color:', ';z-index:1;}}& .input__container{display:flex;flex-direction:row;justify-content:flex-end;align-items:flex-end;padding-right:24px;padding-bottom:13px;flex:1;& input{border:none;outline:none;min-height:88px;padding-top:48px;padding-left:24px;padding-right:56px;padding-bottom:16px;font-size:20px;font-weight:normal;font-style:normal;font-stretch:normal;line-height:1.2;letter-spacing:normal;color:', ';position:absolute;bottom:0;left:0;background:transparent;width:100%;box-sizing:border-box;&::placeholder{font-size:20px;font-style:normal;font-stretch:normal;line-height:1.2;letter-spacing:normal;font-weight:normal;color:', ';}&:disabled,&:disabled::placeholder{font-size:20px;font-weight:normal;font-style:normal;font-stretch:normal;line-height:1.2;letter-spacing:normal;color:', ';}&:-webkit-autofill,&:-webkit-autofill:hover,&:-webkit-autofill:focus{-webkit-transition:\'color 999999s ease-out, background-color 999999s ease-out\';transition:\'color 999999s ease-out, background-color 999999s ease-out\';-webkit-transition-delay:999999s;transition-delay:999999s;}}& input + div{width:24px !important;height:24px !important;}& input + img{width:32px !important;height:32px !important;z-index:10;cursor:pointer;}}}&.box-edit__wrapper .box__wrapper{& .input__container{& input{&:disabled,&:disabled::placeholder{font-size:20px;font-weight:normal;font-style:normal;font-stretch:normal;line-height:1.2;letter-spacing:normal;color:', ';}}}}&.disabled .box__wrapper{& .label__container label:first-child,& label:last-child:not(:first-child){color:', ';}& .input__container input,& .input__container input + img{cursor:not-allowed;}}&.invalid .box__wrapper{& label:last-child:not(:first-child){color:', ';}}'], shared['white'], shared['white'], shared['pale-grey'], shared['light-greyish'], shared['tealish'], shared['bluish-grey'], shared['slate'], shared['slate'], shared['bluey-grey'], shared['cloudy-blue'], shared['slate'], shared['cloudy-blue'], shared['salmon']);

var InputWrapper = function (_Component) {
  inherits(InputWrapper, _Component);

  function InputWrapper() {
    classCallCheck(this, InputWrapper);

    var _this = possibleConstructorReturn(this, (InputWrapper.__proto__ || Object.getPrototypeOf(InputWrapper)).call(this));
  ...
  createClass(InputWrapper, [{
    ...
    key: 'renderElementsFromParent',
    value: function renderElementsFromParent() {
      var labelContainerElement = [];
      ...
      try {
        for (var _iterator = this.props.children[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
          ...
          if (child && (child.type === 'label' || child.type === 'span')) labelContainerElement.push(child);
      ...
      this.setState({
        labelContainerElement: labelContainerElement,
    ...
    value: function render() {
      var _state = this.state,
          labelContainerElement = _state.labelContainerElement,
          inputContainerElement = _state.inputContainerElement;
      ...
      return React.createElement(
        InputSection,
        {
          className: 'box__container ' + (disabled ? 'disabled' : '') + ' ' + (hasError ? 'invalid' : '') + ' box-with-bottom-margin ' + (className || '') },
        React.createElement(
          'div',
...
var _getDisplayName = interopRequireDefault$1(getDisplayName_1$1);
...
var _getPrototypeOf2 = interopRequireDefault$1(getPrototypeOf);
...
var _reactJssContext = interopRequireDefault$1(reactJssContext);

var _jssPreset = interopRequireDefault$1(jssPreset_1);

var _mergeClasses = interopRequireDefault$1(mergeClasses_1);

var _multiKeyStore = interopRequireDefault$1(multiKeyStore_1);
...
/* Primary Colors */
colors['periwinkle'] = '#9966ff';
colors['tealish'] = '#33cccc';
colors['degrade-start'] = '#ab64f5';
colors['degrade-end'] = '#8d85ee';
colors['pale-grey'] = '#f1f5f7';
colors['white'] = '#fff';

/* Secondary Colors */
colors['light-periwinkle'] = '#ddccff';
colors['slate'] = '#4a5365';
colors['bluish-grey'] = '#859099';
colors['bluey-grey'] = '#acbec7';
colors['cloudy-blue'] = '#cfdae1';
colors['light-greyish'] = '#e0e7ec';

/* Terciary Colors */
colors['greenish-teal'] = '#33cc99';
colors['pale-orange'] = '#ff9966';
colors['periwinkle-blue'] = '#9999ff';
colors['bright-light-blue'] = '#33ccff';
colors['sun-yellow'] = '#ffcc33';
colors['salmon'] = '#ff6666';
colors['orchid'] = '#cc66cc';
colors['windows-blue'] = '#3399cc';

/* Default Colors */
colors['primary-color'] = colors['periwinkle'];
colors['secondary-color'] = colors['tealish'];
colors['grey'] = colors['bluish-grey'];
colors['dark-grey'] = colors['slate'];
colors['light-grey'] = colors['pale-grey'];
colors['success'] = colors['greenish-teal'];
colors['alert'] = colors['salmon'];
colors['warning'] = colors['sun-yellow'];
colors['background'] = colors['pale-grey'];
...
var CurrencyInput = function (_Component) {
  ...
  function CurrencyInput(props) {
    ...
    var _this = possibleConstructorReturn(this, (CurrencyInput.__proto__ || Object.getPrototypeOf(CurrencyInput)).call(this));

    _this.currencyInput = null;
    ...
    _this.onBlurInputHandler = _this.onBlurInputHandler.bind(_this);
    _this.onClickIconHandler = _this.onClickIconHandler.bind(_this);
    _this.onFocusInputHandler = _this.onFocusInputHandler.bind(_this);
    _this.onChangeInputHandler = _this.onChangeInputHandler.bind(_this);
    return _this;
  }

  createClass(CurrencyInput, [{
    key: 'onFocusInputHandler',
    value: function onFocusInputHandler(ev) {
    ...
    key: 'onBlurInputHandler',
    value: function onBlurInputHandler(ev) {
      var _this2 = this;
    ...
    key: 'onClickIconHandler',
    value: function onClickIconHandler() {
      var _this3 = this;
      ...
      this.setState({ value: '' }, function () {
        _this3.currencyInput.theInput.focus();
      });
    ...
    value: function onChangeInputHandler(ev, maskedValue, rawValue) {
    ...
    value: function renderIcon() {
      ...
      if (isLoading) return React.createElement(CircularProgress$2, null);

      if (enableClear && focused && touched) return React.createElement('img', { alt: '', src: '/images/erase.svg', onClick: this.onClickIconHandler });

      if (hasError) return React.createElement('img', { src: '/images/error_input.svg', alt: '' });

      if (isValid) return React.createElement('img', { src: '/images/success_input.svg', alt: '' });
    }
  }, {
    key: 'render',
    value: function render() {
      ...
      var _props2 = this.props,
          ...
          enableClear = _props2.enableClear,
          searchIcon = _props2.searchIcon,
          isLoading = _props2.isLoading,
          other = objectWithoutProperties(_props2, ['label', 'message', 'errorMessage', 'hasError', 'disabled', 'isValid', 'onClear', 'enableClear', 'searchIcon', 'isLoading']);


      return React.createElement(
        InputWrapper,
        { hasError: hasError, disabled: disabled },
        React.createElement(
          'label',
          null,
          label
        ),
        errorMessage || message ? React.createElement(
          'label',
          { style: { color: colors['bluish-grey'] } },
          errorMessage || message
        ) : null,
        React.createElement(
          Fragment,
          null,
          React.createElement(CI, _extends({}, other, {
            ref: function ref(input) {
              _this4.currencyInput = input;
            },
