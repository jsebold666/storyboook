...
var _getDisplayName = interopRequireDefault$4(getDisplayName_1$1);
...
var _jssGlobal = interopRequireDefault$4(lib$1);

var _jssNested = interopRequireDefault$4(lib$2);

var _jssCamelCase = interopRequireDefault$4(lib$3);

var _jssDefaultUnit = interopRequireDefault$4(lib$4);

var _jssVendorPrefixer = interopRequireDefault$4(lib$6);

var _jssPropsSort = interopRequireDefault$4(lib$7);
...
var _extends2 = interopRequireDefault$4(_extends_1);

var _warning = interopRequireDefault$4(warning_1);

var _getDisplayName = interopRequireDefault$4(getDisplayName_1$2);
...
var _objectWithoutProperties2 = interopRequireDefault$4(objectWithoutProperties);
...
var _defineProperty2 = interopRequireDefault$4(defineProperty);

var _extends3 = interopRequireDefault$4(_extends_1);
...
var _deepmerge = interopRequireDefault$4(require$$3);

var _indigo = interopRequireDefault$4(indigo_1);

var _pink = interopRequireDefault$4(pink_1);

var _grey = interopRequireDefault$4(grey_1);

var _red = interopRequireDefault$4(red_1);

var _common = interopRequireDefault$4(common_1);
...
var _isPlainObject = interopRequireDefault$4(isPlainObject);

var _warning = interopRequireDefault$4(warning_1);

var _createBreakpoints = interopRequireDefault$4(createBreakpoints_1);

var _createMixins = interopRequireDefault$4(createMixins_1);

var _createPalette = interopRequireDefault$4(createPalette_1);

var _createTypography = interopRequireDefault$4(createTypography_1);

var _shadows = interopRequireDefault$4(shadows_1);

var _shape = interopRequireDefault$4(shape_1);

var _spacing = interopRequireDefault$4(spacing_1);

var _transitions = interopRequireDefault$4(transitions);

var _zIndex = interopRequireDefault$4(zIndex_1);
...
var _typeof2 = interopRequireDefault$4(_typeof_1);
...
var _classCallCheck2 = interopRequireDefault$4(classCallCheck);

var _createClass2 = interopRequireDefault$4(createClass);

var _possibleConstructorReturn2 = interopRequireDefault$4(possibleConstructorReturn);

var _getPrototypeOf2 = interopRequireDefault$4(getPrototypeOf);

var _inherits2 = interopRequireDefault$4(inherits);

var _objectWithoutProperties2 = interopRequireDefault$4(objectWithoutProperties);

var _react = interopRequireDefault$4(React);

var _propTypes = interopRequireDefault$4(require$$0);

var _warning = interopRequireDefault$4(warning_1);

var _hoistNonReactStatics = interopRequireDefault$4(hoistNonReactStatics_cjs);

var _wrapDisplayName = interopRequireDefault$4(wrapDisplayName_1$1);



var _reactJssContext = interopRequireDefault$4(reactJssContext);

var _jssPreset = interopRequireDefault$4(jssPreset_1);

var _mergeClasses = interopRequireDefault$4(mergeClasses_1);

var _multiKeyStore = interopRequireDefault$4(multiKeyStore_1);

var _createMuiTheme = interopRequireDefault$4(createMuiTheme_1);

var _themeListener = interopRequireDefault$4(themeListener_1);

var _createGenerateClassName = interopRequireDefault$4(createGenerateClassName_1);

var _getStylesCreator = interopRequireDefault$4(getStylesCreator_1);

var _getDisplayName = interopRequireDefault$4(getDisplayName_1$2);

var _getThemeProps = interopRequireDefault$4(getThemeProps_1);
...
var _classnames = interopRequireDefault$4(classnames);

var _withStyles = interopRequireDefault$4(withStyles_1);
...
var _SvgIcon = interopRequireDefault$4(SvgIcon_1);
});
...
var _ownerDocument = interopRequireDefault$4(ownerDocument_1);
...
var _getPrototypeOf3 = interopRequireDefault$4(getPrototypeOf);
...
var _exactProp = interopRequireDefault$4(exactProp_1);
...
var _NoSsr = interopRequireDefault$4(NoSsr_1);
});
...
var _keycode = interopRequireDefault$4(keycode);
...
var _Transition = interopRequireDefault$4(Transition_1);
...
var _toConsumableArray2 = interopRequireDefault$4(toConsumableArray);
...
var _assertThisInitialized2 = interopRequireDefault$4(assertThisInitialized);

var _react = interopRequireDefault$4(React);

var _propTypes = interopRequireDefault$4(require$$0);

var _reactDom = interopRequireDefault$4(reactDom);

var _TransitionGroup = interopRequireDefault$4(TransitionGroup_1);

var _classnames = interopRequireDefault$4(classnames);

var _withStyles = interopRequireDefault$4(withStyles_1);

var _Ripple = interopRequireDefault$4(Ripple_1);
...
var _ownerWindow = interopRequireDefault$4(ownerWindow_1);

var _withStyles = interopRequireDefault$4(withStyles_1);

var _NoSsr = interopRequireDefault$4(NoSsr$1);



var _TouchRipple = interopRequireDefault$4(TouchRipple_1);

var _createRippleHandler = interopRequireDefault$4(createRippleHandler_1);
...
var _ButtonBase = interopRequireDefault$4(ButtonBase_1);
});
...
var _ButtonBase = interopRequireDefault$4(ButtonBase$1);
...
var _IconButton = interopRequireDefault$4(IconButton_1);
});

var IconButton$2 = unwrapExports(IconButton$1);

var KeyboardBackspace = createCommonjsModule(function (module, exports) {
...
var BackIcon = unwrapExports(KeyboardBackspace);
...
var Nav = styled.div.withConfig({
  ...
  componentId: 'sc-1mrlnwx-0'
})(['.row.row-center{align-items:center;justify-content:center;}.row{display:flex;flex-direction:row;}.container{box-sizing:border-box;width:100%;@media (min-width:', '){max-width:768px;margin:24px auto;}}.flex1{flex:1 1;}.justify-between{justify-content:space-between !important;}.navbar__container{box-sizing:border-box;width:100%;height:56px;background-image:linear-gradient( to right,', ',', ' );color:white;padding:16px 0;align-items:center;display:flex;& .container{margin:0 auto;padding:0 16px;.navbar__icon-button{color:', ';&:hover{opacity:0.7;}}@media (min-width:', '){padding:0;}}&.transparent{background-image:none;}& .navbar__icon{&-alert{margin-left:32px;}&-user{margin-left:16px;}&-return{display:flex;justify-content:center;margin-right:24px;}&-circle{width:32px;height:32px;opacity:0.5;border:solid 4px #ffffff;margin-right:16px;border-radius:50%;}}@media (min-width:', '){height:88px;padding:10px 0;}}'], shared['mobile-break-point'], shared['degrade-start'], shared['degrade-end'], shared['white'], shared['mobile-break-point'], shared['mobile-break-point']);

var Navbar = function (_Component) {
  inherits$1(Navbar, _Component);

  function Navbar(props) {
    classCallCheck$1(this, Navbar);

    var _this = possibleConstructorReturn$1(this, (Navbar.__proto__ || Object.getPrototypeOf(Navbar)).call(this, props));
  ...
  createClass$1(Navbar, [{
    ...
    key: 'renderCloseIconIfNecessary',
    value: function renderCloseIconIfNecessary(shouldHide) {
      return shouldHide ? React.createElement('div', null) : this.renderButton(React.createElement(CloseIcon, null), this.onCloseClick);
    }
  }, {
    key: 'renderBackButtonIfNecessary',
    value: function renderBackButtonIfNecessary(shouldRender) {
      return !shouldRender ? React.createElement('div', { style: { width: '48px' } }) : this.renderButton(React.createElement(BackIcon, null), this.previousPage);
    }
  }, {
    key: 'renderButton',
    value: function renderButton(icon, action) {
      return React.createElement(
        IconButton$2,
        { className: 'navbar__icon-button', onClick: action },
        icon
      );
    }
  }, {
    ...
    value: function render() {
      ...
      return React.createElement(
        ...
        React.createElement(
          'header',
          { className: 'navbar__container ' + (isTransparent ? 'transparent' : '') },
          React.createElement(
            'div',
            { className: 'container' },
            React.createElement(
...
var Wrapper = styled.div.withConfig({
  ...
  componentId: 'tsuvl5-0'
})(['.option_selector_container{ul{list-style:none;padding:0 5%;li{color:#acbec7;height:60px;line-height:58px;cursor:pointer;border-bottom:1px solid ', ';img{margin-right:10px;}}}}'], shared['cloudy-blue']);

var OptionSelector = function (_Component) {
  inherits$1(OptionSelector, _Component);

  function OptionSelector(props) {
    classCallCheck$1(this, OptionSelector);

    var _this = possibleConstructorReturn$1(this, (OptionSelector.__proto__ || Object.getPrototypeOf(OptionSelector)).call(this, props));

    _this.state = {};
    return _this;
  }

  createClass$1(OptionSelector, [{
    key: 'renderOptions',
    value: function renderOptions() {
      var _this2 = this;

      if (!!this.props.options) {
        var result = this.props.options.map(function (item, idx) {
          var klass = {
          ...
          return React.createElement(
            'li',
            { key: idx, id: item.id, style: klass, onClick: _this2.handleSelectOption.bind(_this2) },
            React.createElement('img', { src: item.img, alt: item.text }),
            item.text
          );
        });
        return result;
    ...
    value: function handleSelectOption(ev) {
