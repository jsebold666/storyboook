...
(function (global, factory) {
   ...
   factory(global.moment);
    ...
    var ptBr = moment$$1.defineLocale('pt-br', {
...
function formatRange(startDate, endDate) {
  var desde = moment(startDate);
  var ate = moment(endDate);
  return moment(desde).locale('pt-br', ptBr).format('DD MMM YYYY') + ' - ' + moment(ate).locale('pt-br', ptBr).format('DD MMM YYYY');
}
...
export { formatDate, formatRange, formatCurrency };
